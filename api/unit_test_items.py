...
def test_load_items(items_instance):
    mock_data = '[{"uid": 1, "name": "Test Item"}]'
...
def test_get_items(items_instance):
    items_instance.data = [{"uid": 1, "name": "Test Item"}]
...
def test_update_item(items_instance):
    items_instance.data = [{"uid": 1, "name": "Old Item"}]
    updated_item = {"uid": 1, "name": "Updated Item"}
...
def test_get_items_for_item_line(items_instance):
    items_instance.data = [
        {"uid": 1, "item_line": 2, "name": "Item Line 1"},
        {"uid": 2, "item_line": 1, "name": "Item Line 2"}
    ]
...
def test_get_items_for_item_group(items_instance):
    items_instance.data = [
        {"uid": 1, "item_group": 2, "name": "Group Item 1"},
        {"uid": 2, "item_group": 1, "name": "Group Item 2"}
    ]
...
def test_get_items_for_item_type(items_instance):
    items_instance.data = [
        {"uid": 1, "item_type": 2, "name": "Type Item 1"},
        {"uid": 2, "item_type": 1, "name": "Type Item 2"}
    ]
...
def test_get_items_for_supplier(items_instance):
    items_instance.data = [
        {"uid": 1, "supplier_id": 2, "name": "Supplier Item 1"},
        {"uid": 2, "supplier_id": 1, "name": "Supplier Item 2"}
    ]
