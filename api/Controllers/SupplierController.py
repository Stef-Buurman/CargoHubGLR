...
def update_supplier(supplier_id: int, supplier: dict, api_key: str = Depends(auth_provider.get_api_key)):
    data_provider.init()
...
def delete_supplier(supplier_id: int, api_key: str = Depends(auth_provider.get_api_key)):
    data_provider.init()
