...
def read_item_line(item_line_id: int, api_key: str = Depends(auth_provider.get_api_key)):
    data_provider.init()
...
def read_items_for_item_line(item_line_id: int, api_key: str = Depends(auth_provider.get_api_key)):
    data_provider.init()
...
def update_item(item_line_id: int, item_line: dict, api_key: str = Depends(auth_provider.get_api_key)):
    data_provider.init()
