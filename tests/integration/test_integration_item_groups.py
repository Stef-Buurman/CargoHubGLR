...
#     assert response.status_code == 403
#     responseGet = client.get('/item_groups/' + str(test_item_group['id']), headers=test_headers)
#     assert responseGet.status_code == 404

# def test_add_item_group_invalid_api_key(client):
#     response = client.post('/item_groups/', json=test_item_group, headers=invalid_headers)
#     assert response.status_code == 403
#     responseGet = client.get('/item_groups/' + str(test_item_group['id']), headers=test_headers)
#     assert responseGet.status_code == 404
...
#     response = client.get('/item_groups/' + str(test_item_group['id']), headers=test_headers)
#     assert response.status_code == 200
...
#     response = client.get('/item_groups/' + str(test_item_group['id']), headers=invalid_headers)
#     assert response.status_code == 403 
...
#     response = client.get(f"/item_groups/{test_item_group['id']}/items", headers=test_headers)
#     assert response.status_code == 200
...
#     response = client.get(f"/item_groups/{test_item_group['id']}/items", headers=invalid_headers)
#     assert response.status_code == 403
...
#     updated_item_group = test_item_group.copy()
#     updated_item_group['name'] = 'Updated Inc'
#     response = client.put("/item_groups/invalid_id", json=updated_item_group, headers=test_headers)
#     assert response.status_code == 422

# def test_update_nonexistent_item_group(client):
#     updated_item_group = test_item_group.copy()
#     updated_item_group['name'] = 'Updated Inc'
#     response = client.put(f"/item_groups/{non_existent_id}", json=updated_item_group, headers=test_headers)
#     assert response.status_code == 404

# def test_update_item_group(client):
#     updated_item_group = test_item_group.copy()
#     updated_item_group['name'] = 'Updated Inc'
#     response = client.put(f"/item_groups/{test_item_group['id']}", json=updated_item_group, headers=test_headers)
#     assert response.status_code == 200
#     response_get_item_group = client.get(f"/item_groups/{test_item_group['id']}", headers=test_headers)
#     assert response_get_item_group.status_code == 200
...
#     assert response.status_code == 403
#     response_get_item_group = client.get('/item_groups/' + str(test_item_group['id']), headers=test_headers)
#     assert response_get_item_group.status_code == 200

# def test_delete_item_group_invalid_api_key(client):
#     response = client.delete('/item_groups/' + str(test_item_group['id']), headers=invalid_headers)
#     assert response.status_code == 403
#     response_get_item_group = client.get('/item_groups/' + str(test_item_group['id']), headers=test_headers)
#     assert response_get_item_group.status_code == 200

# def test_delete_item_group(client):
#     response = client.delete('/item_groups/' + str(test_item_group['id']), headers=test_headers)
#     assert response.status_code == 200
#     response_get_item_group = client.get('/item_groups/' + str(test_item_group['id']), headers=test_headers)
