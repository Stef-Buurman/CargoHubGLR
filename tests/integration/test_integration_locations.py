...
#     assert response.status_code == 403
#     responseGet = client.get('/locations/' + str(test_location['id']), headers=test_headers)
...
#     response = client.get('/locations/' + str(test_location['id']), headers=test_headers)
#     assert response.status_code == 200
...
#     response = client.get('/locations/' + str(test_location['id']), headers=invalid_headers)
#     assert response.status_code == 403
...
#     response = client.put('/locations/' + str(test_location['id']), json=test_location, headers=invalid_headers)
#     assert response.status_code == 403


# def test_update_non_existent_location(client):
#     response = client.put('/locations/' + str(non_existent_id), json=test_location, headers=test_headers)
#     assert response.status_code == 404


# def test_update_invalid_location_id(client):
#     response = client.put('/locations/invalid_id', json=test_location, headers=test_headers)
#     assert response.status_code == 422
...
#     response = client.put('/locations/' + str(test_location_copy['id']), json=test_location_copy, headers=test_headers)
#     assert response.status_code == 200
#     assert response.json() is not None
#     assert isinstance(response.json(), dict)
#     responseGet = client.get('/locations/' + str(test_location_copy['id']), headers=test_headers)
...
#     response = client.delete('/locations/' + str(test_location['id']), headers=invalid_headers)
#     assert response.status_code == 403
#     responseGet = client.get('/locations/' + str(test_location['id']), headers=test_headers)
#     assert responseGet.status_code == 200
...
#     response = client.delete('/locations/' + str(test_location['id']), headers=test_headers)
#     assert response.status_code == 200
#     responseGet = client.get('/locations/' + str(test_location['id']), headers=test_headers)
#     assert responseGet.status_code == 404