...
#     assert response.status_code == 403
#     responseGet = client.get('/item_lines/' + str(test_item_line['id']), headers=test_headers)
...
#     response = client.get('/item_lines/' + str(test_item_line['id']), headers=test_headers)
#     assert response.status_code == 200
...
#     response = client.get('/item_lines/' + str(test_item_line['id']), headers=invalid_headers)
#     assert response.status_code == 403
...
#     response = client.put('/item_lines/' + str(updated_item_line['id']), json=updated_item_line)
#     assert response.status_code == 403
#     response_get_item_line = client.get('/item_lines/' + str(updated_item_line['id']), headers=test_headers)
...
#     updated_item_line = test_item_line.copy()
#     updated_item_line['description'] = 'updated item line'
#     response = client.put('/item_lines/' + str(updated_item_line['id']), json=updated_item_line, headers=invalid_headers)
#     assert response.status_code == 403
#     response_get_item_line = client.get('/item_lines/' + str(updated_item_line['id']), headers=test_headers)
#     assert response_get_item_line.status_code == 200
#     assert response_get_item_line.json()['description'] == test_item_line['description']
...
#     updated_item_line = test_item_line.copy()
#     updated_item_line['description'] = 'updated item line'
#     response = client.put('/item_lines/invalid_id', json=updated_item_line, headers=test_headers)
#     assert response.status_code == 422
...
#     updated_item_line = test_item_line.copy()
#     updated_item_line['description'] = 'updated item line'
#     response = client.put('/item_lines/' + str(non_existent_id), json=updated_item_line, headers=test_headers)
#     assert response.status_code == 404
...
#     updated_item_line = test_item_line.copy()
#     updated_item_line['description'] = 'updated item line'
#     response = client.put('/item_lines/' + str(updated_item_line['id']), json=updated_item_line, headers=test_headers)
#     assert response.status_code == 200
#     response_get_item_line = client.get('/item_lines/' + str(updated_item_line['id']), headers=test_headers)
#     assert response_get_item_line.status_code == 200
#     assert response_get_item_line.json()['description'] == updated_item_line['description']


# def test_delete_item_line_no_api_key(client):
#     response = client.delete('/item_lines/' + str(test_item_line['id']))
#     assert response.status_code == 403
#     response_get_item_line = client.get('/item_lines/' + str(test_item_line['id']), headers=test_headers)
#     assert response_get_item_line.status_code == 200


# def test_delete_item_line_invalid_api_key(client):
#     response = client.delete('/item_lines/' + str(test_item_line['id']), headers=invalid_headers)
#     assert response.status_code == 403
#     response_get_item_line = client.get('/item_lines/' + str(test_item_line['id']), headers=test_headers)
#     assert response_get_item_line.status_code == 200
...
#     response = client.delete('/item_lines/' + str(non_existent_id), headers=test_headers)
#     assert response.status_code == 404
#     response_get_item_line = client.get('/item_lines/' + str(test_item_line['id']), headers=test_headers)
#     assert response_get_item_line.status_code == 200
...
#     response = client.delete('/item_lines/' + str(test_item_line['id']), headers=test_headers)
#     assert response.status_code == 200
#     response_get_item_line = client.get('/item_lines/' + str(test_item_line['id']), headers=test_headers)
